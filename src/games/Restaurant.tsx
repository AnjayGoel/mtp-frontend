      ...
      <div style={{display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column'}}>
        ...
        <Paragraph style={{padding: '10px'}}>
          ...
          <ul>
            ...
            <li>If you <Text strong>lower</Text> the price, while the other player keeps it <Text
              strong>high</Text>, you will earn <Text strong>₹10</Text>, while the other would lose ₹2.5. And
              vice versa.
            </li>
